...
import org.example.labbb1.dto.EditChapterDTO;
import org.example.labbb1.dto.EditCoordinatesDTO;
import org.example.labbb1.dto.EditSpaceMarineDTO;
...
public class EditController {
    ...
    public ResponseEntity<?> getEditChapters(@PathVariable Long id){
        ...
        Iterable<EditChapterDTO> chapters = editService.getEditChapterByChapter(chapter);
...
//        });
    ...
    public ResponseEntity<?> getEditCoords(@PathVariable Long id){
        ...
        Iterable<EditCoordinatesDTO> coords = editService.getEditCoordByCoords(coordinates);
...
//        });
    ...
    public ResponseEntity<?> getEditSpaceMarine(
        ...
        Iterable<EditSpaceMarineDTO> spaceMarines = editService.getEditSpaceMarineBySPaceMarine(spaceMarine);
